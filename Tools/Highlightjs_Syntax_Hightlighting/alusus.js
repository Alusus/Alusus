...
function(hljs) {
  var KEYWORDS =
    ...
    'noexcept nullptr static_assert thread_local restrict alias dump_ast init preprocess ast ast_ref as_ptr set_ptr ' +
    'اشمل عرف عرّف وحدة دالة دالّة هيكل إذا بينما لكل أرجع ارجع مؤشر محتوى مصفوفة أيما  لقب شبم مغلفة كمؤشر حدد_مؤشر ' +
    'صنف وإلا اقطع أكمل أدرج_ش_ب_م و أو ليس ماكرو استخدم سند سند_مؤقت عملية هذا هذا_الصنف قيمة هيئ تمهيد بلا_حقن سند_شبم';
  return {
    aliases: ['alusus'],
    keywords: KEYWORDS,
