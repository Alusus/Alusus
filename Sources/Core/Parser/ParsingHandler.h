...
class ParsingHandler : public Data::OperationHandler
{
   ...
   */
  public: virtual void onProdStart(State *state)
  {
  }
   ...
   */
  public: virtual void onProdEnd(State *state)
  {
  }
   ...
   */
  public: virtual void onTermStart(State *state)
  {
  }
   ...
   * @param state The subject state.
   */
  public: virtual void onTermEnd(State *state)
  {
  }
   ...
   *             call is complete.
   */
  public: virtual void onLevelExit(State *state, const SharedPtr<IdentifiableObject> &data)
  {
  }
   ...
   */
  public: virtual void onNewToken(State *state, const Common::Token *token)
  {
  }
   ...
   */
  public: virtual Bool onErrorToken(State *state, const Common::Token *token)
  {
    return false;
  }
   ...
   */
  public: virtual void onAlternateRouteDecision(State *state, Int route)
  {
  }
   ...
   */
  public: virtual void onMultiplyRouteDecision(State *state, Int route)
  {
  }
   ...
   */
  public: virtual void onConcatStep(State *state, Int newPos)
  {
  }
   ...
   */
  public: virtual void onBranching(State *state)
  {
  }
   ...
   */
  public: virtual void onBranched(State *state1, State *state2)
  {
  }
   ...
   *                    duplicated.
   */
  public: virtual void onTermLevelDuplicating(State *state, Int prodOffset, Int termOffset)
  {
  }
   ...
   */
  public: virtual void onProdLevelDuplicating(State *state, Int prodOffset, Int termOffset)
  {
  }
   ...
   */
  public: virtual void onTermLevelDuplicated(State *state1, State *state2, Int prodOffset, Int termOffset)
  {
  }
   ...
   * @note The offset are the same in both states.
   */
  public: virtual void onProdLevelDuplicated(State *state1, State *state2,
   ...
   * @param state The subject state.
   */
  public: virtual void onTermCancelling(State *state)
  {
  }
   ...
   * @param state The subject state.
   */
  public: virtual void onProdCancelling(State *state)
  {
  }
   ...
   *                     a single state.
   */
  public: virtual void onStateCancelling(State *canceledState, State *winnerState)
  {
  }
