...
#ifndef PARSER_PARSING_HANDLER_H
#define PARSER_PARSING_HANDLER_H
...
class ParsingHandler : public Data::OperationHandler
{
   ...
   */
  public: virtual void onProdStart(StateMachine *machine, State *state)
  {
  }
   ...
   */
  public: virtual void onProdEnd(StateMachine *machine, State *state)
  {
  }
   ...
   */
  public: virtual void onTermStart(StateMachine *machine, State *state)
  {
  }
   ...
   * @param state The subject state.
   */
  public: virtual void onTermEnd(StateMachine *machine, State *state)
  {
  }
   ...
   */
  public: virtual void onNewToken(StateMachine *machine, State *state, const Common::Token *token)
  {
  }
   ...
   */
  public: virtual Bool onErrorToken(StateMachine *machine, State *state, const Common::Token *token)
  {
    return false;
  }
   ...
   */
  public: virtual void onAlternateRouteDecision(StateMachine *machine, State *state, Int route)
  {
  }
   ...
   */
  public: virtual void onMultiplyRouteDecision(StateMachine *machine, State *state, Int route)
  {
  }
   ...
   */
  public: virtual void onConcatStep(StateMachine *machine, State *state, Int newPos)
  {
  }
   ...
   */
  public: virtual void onBranching(StateMachine *machine, State *state)
  {
  }
   ...
   */
  public: virtual void onBranched(StateMachine *machine, State *state1, State *state2)
  {
  }
   ...
   *                    duplicated.
   */
  public: virtual void onTermLevelDuplicating(StateMachine *machine, State *state, Int prodOffset, Int termOffset)
  {
  }
   ...
   */
  public: virtual void onProdLevelDuplicating(StateMachine *machine, State *state, Int prodOffset, Int termOffset)
  {
  }
   ...
   */
  public: virtual void onTermLevelDuplicated(StateMachine *machine, State *state1, State *state2,
   ...
   * @note The offset are the same in both states.
   */
  public: virtual void onProdLevelDuplicated(StateMachine *machine, State *state1, State *state2,
                                             Int prodOffset, Int termOffset)
  {
  }
   ...
   * @param state The subject state.
   */
  public: virtual void onTermCancelling(StateMachine *machine, State *state)
  {
  }
   ...
   * @param state The subject state.
   */
  public: virtual void onProdCancelling(StateMachine *machine, State *state)
  {
  }
   ...
   *                     a single state.
   */
  public: virtual void onStateCancelling(StateMachine *machine, State *canceledState, State *winnerState)
  {
  }
