...
#ifndef PROCESSING_PARSING_HANDLER_H
#define PROCESSING_PARSING_HANDLER_H
...
class ParsingHandler : public Data::OperationHandler
{
   ...
   */
  public: virtual void onProdStart(Parser *machine, ParserState *state)
  {
  }
   ...
   */
  public: virtual void onProdEnd(Parser *machine, ParserState *state)
  {
  }
   ...
   */
  public: virtual void onTermStart(Parser *machine, ParserState *state)
  {
  }
   ...
   * @param state The subject state.
   */
  public: virtual void onTermEnd(Parser *machine, ParserState *state)
  {
  }
   ...
   *             call is complete.
   */
  public: virtual void onLevelExit(Parser *machine, ParserState *state, SharedPtr<IdentifiableObject> const &data)
  {
  }
   ...
   */
  public: virtual void onNewToken(Parser *machine, ParserState *state, const Common::Token *token)
  {
  }
   ...
   */
  public: virtual Bool onErrorToken(Parser *machine, ParserState *state, const Common::Token *token)
  {
    return false;
  }
   ...
   */
  public: virtual void onAlternateRouteDecision(Parser *machine, ParserState *state, Int route)
  {
  }
   ...
   */
  public: virtual void onMultiplyRouteDecision(Parser *machine, ParserState *state, Int route)
  {
  }
   ...
   */
  public: virtual void onConcatStep(Parser *machine, ParserState *state, Int newPos)
  {
  }
   ...
   */
  public: virtual void onBranching(Parser *machine, ParserState *state)
  {
  }
   ...
   */
  public: virtual void onBranched(Parser *machine, ParserState *state1, ParserState *state2)
  {
  }
   ...
   *                    duplicated.
   */
  public: virtual void onTermLevelDuplicating(Parser *machine, ParserState *state, Int prodOffset, Int termOffset)
  {
  }
   ...
   */
  public: virtual void onProdLevelDuplicating(Parser *machine, ParserState *state, Int prodOffset, Int termOffset)
  {
  }
   ...
   */
  public: virtual void onTermLevelDuplicated(Parser *machine, ParserState *state1, ParserState *state2,
   ...
   * @note The offset are the same in both states.
   */
  public: virtual void onProdLevelDuplicated(Parser *machine, ParserState *state1, ParserState *state2,
                                             Int prodOffset, Int termOffset)
  {
  }
   ...
   * @param state The subject state.
   */
  public: virtual void onTermCancelling(Parser *machine, ParserState *state)
  {
  }
   ...
   * @param state The subject state.
   */
  public: virtual void onProdCancelling(Parser *machine, ParserState *state)
  {
  }
   ...
   *                     a single state.
   */
  public: virtual void onStateCancelling(Parser *machine, ParserState *canceledState, ParserState *winnerState)
  {
  }
