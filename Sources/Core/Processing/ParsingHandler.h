...
class ParsingHandler : public Data::OperationHandler
{
   ...
   */
  public: virtual void onNewToken(Parser *machine, ParserState *state, const Data::Token *token)
  {
  }
   ...
   */
  public: virtual Bool onErrorToken(Parser *machine, ParserState *state, const Data::Token *token)
  {
    return false;
  }
