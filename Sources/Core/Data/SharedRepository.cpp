...
void SharedRepository::remove(Reference const *ref, SeekerRemoveLambda handler)
{
  if (ref->isA<ScopeReference>()) {
...
void SharedRepository::remove(Char const *qualifier, SeekerRemoveLambda handler)
{
  Char const *qualifier2 = qualifier;
  ReferenceParser parser;
  Reference const *ref = &parser.parseQualifierSegmentToTemp(qualifier2);
...
void SharedRepository::forEach(Reference const *ref, SeekerForeachLambda handler,
...
void SharedRepository::forEach(Char const *qualifier, SeekerForeachLambda handler,
                               TypeInfo const *parentTypeInfo)
{
  Char const *qualifier2 = qualifier;
  ReferenceParser parser;
