/**
 * @file Core/Data/PlainContainer.h
 * Contains the header of interface Data::PlainContainer.
 *
...
class PlainContainer : public IdentifiableInterface
{
  //============================================================================
  // Type Info

  INTERFACE_INFO(PlainContainer, IdentifiableInterface, "Core.Data", "Core", "alusus.net");
  ...
  public: SIGNAL(contentChangeNotifier, (PlainContainer *obj, ContentChangeOp op, Int index), (obj, op, index));
