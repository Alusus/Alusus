...
#ifndef COMMON_BUILD_MSG_H
#define COMMON_BUILD_MSG_H
...
class BuildMsg : public IdentifiableObject
{
  ...
  TYPE_INFO(BuildMsg, IdentifiableObject, "Core.Common", "Core", "alusus.net");
   ...
   * Lexer and P for Parser) followed by a number identifying the message
