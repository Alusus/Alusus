...
DEFINE_NOTICE(InvalidTypeMemberNotice, "Spp.LlvmCodeGen", "Spp", "alusus.net", "SPP1306", 1,
  STR("No valid match was found for the given type member.")
);
DEFINE_NOTICE(InvalidFloatBitCountNotice, "Spp.LlvmCodeGen", "Spp", "alusus.net", "SPP1307", 1,
  STR("Invalid float bit count. Bit count should be either 32, 64, or 128.")
);
DEFINE_NOTICE(InvalidIntegerBitCountNotice, "Spp.LlvmCodeGen", "Spp", "alusus.net", "SPP1308", 1,
  STR("Invalid integer bit count.")
);
DEFINE_NOTICE(InvalidCastNotice, "Spp.LlvmCodeGen", "Spp", "alusus.net", "SPP1309", 1,
  STR("Invalid cast.")
);
DEFINE_NOTICE(InvalidReturnValueNotice, "Spp.LlvmCodeGen", "Spp", "alusus.net", "SPP1310", 1,
