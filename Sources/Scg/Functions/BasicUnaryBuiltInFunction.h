/**
 * @file Scg/Functions/BasicUnaryBuiltInFunction.h
 *
...
#ifndef SCG_BASICUNARYBUILTINFUNCTION_H
#define SCG_BASICUNARYBUILTINFUNCTION_H
 ...
 */
class BasicUnaryBuiltInFunction : public Function
{
  //============================================================================
  // Type Info

  TYPE_INFO(BasicUnaryBuiltInFunction, Function, "Scg", "Scg", "alusus.net");


  //============================================================================
  // Types

  public: using Callback = std::function < llvm::Value*(llvm::IRBuilder<> *irb, llvm::Value*) > ;
  ...
  */
  public: BasicUnaryBuiltInFunction(const Core::Basic::Char *name, const Core::Basic::Char *retType,
