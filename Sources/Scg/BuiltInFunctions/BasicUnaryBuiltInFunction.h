/**
 * @file Scg/BuiltInFunctions/BasicUnaryBuiltInFunction.h
 *
...
#ifndef __BasicUnaryBuiltInFunction_h__
#define __BasicUnaryBuiltInFunction_h__
...
{
public:
  using Callback = std::function<llvm::Value*(llvm::IRBuilder<> *irb, llvm::Value*)>;
...
#endif // __BasicUnaryBuiltInFunction_h__
