...
SharedPtr<ValueTypeSpec> const& ArrayElementReference::getValueTypeSpec() const
{
  if (this->valueType)
...
AstNode::CodeGenerationStage ArrayElementReference::generateCode(CodeGenUnit *codeGenUnit)
{
  BLOCK_CHECK;
